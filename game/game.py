...
def pygame1(people):
	...
	while True:
		...
		for enemy in enemies :
			if enemy.laser == 1 :
				new_laser = LaserEnemy(enemy.rect.centerx, enemy.rect.centery,height)
			...
			if enemy.laser >= 180:
				...
				all_sprites.add(new_laser)
				enemy.laser = 0
		gets_enemy = pygame.sprite.groupcollide(laser_enemy, player, True,True)
		if gets_enemy :
			music_kill.play()
